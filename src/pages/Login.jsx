...
const Login = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            const redirect = location.search ? location.search.split('=')[1] : (user.role === 'admin' ? '/admin' : '/');
            navigate(redirect);
        }
        ...
        <div className="min-h-screen bg-royal-blue flex justify-center items-center px-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    <h2 className="text-4xl font-playfair text-off-white mb-2">Welcome Back</h2>
                    <p className="text-gray-400 font-lato text-sm">Please enter your details to sign in</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="group">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl py-4 px-5 text-white font-lato placeholder:text-gray-600 focus:outline-none focus:border-royal-gold focus:bg-white/10 transition-all duration-300"
                            value={email}
                ...
                <div className="mt-8 text-center font-lato text-sm">
                    ...
                    <Link to="/register" className="text-royal-gold hover:text-white transition-colors underline underline-offset-4">
                        Create an Account
                    </Link>
                </div>
            </motion.div>
